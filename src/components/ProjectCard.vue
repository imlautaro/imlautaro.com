...
defineProps<{ title: string; description: string; url: string; tag: string }>()
</script>

<template>
	<Stack
		class="border-2 px-6 py-8 rounded-2xl -mx-3 text-center"
		gap="4"
		items="center"
		vertical
	>
		...
		<NuxtLink
			...
			target="_blank"
		>
			<Icon class="text-xs" name="lucide:link" />
